...
OKLM est une application qui permet aux etudiants de faire des reservations de places de restaurant et de cinema universitaire
acces y est possible avec ou sans matricule .Pour le moment on est qu'a l'affichage et au choix des differents menus.
